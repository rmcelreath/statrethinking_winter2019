...
1. [Python Implementation](https://github.com/gbosquechacon/statrethink_course_in_pymc3) of homeworks
1. Other Python based [homework solutions](https://github.com/petrushev/statistical-rethinking)
